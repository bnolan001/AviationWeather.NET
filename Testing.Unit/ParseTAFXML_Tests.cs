...
namespace Testing.Unit
{
    public class ParseTAFXML_Tests
    {
        ...
        public void Parse_SingleStation_General()
        {
            ...
            taf.IssuedTime.Should().Be(DateTime.Parse("2019-10-26T23:20:00Z"));
            taf.BulletinTime.Should().Be(DateTime.Parse("2019-10-26T23:20:00Z"));
            taf.ValidTimeStart.Should().Be(DateTime.Parse("2019-10-27T00:00:00Z"));
            taf.ValidTimeEnd.Should().Be(DateTime.Parse("2019-10-28T06:00:00Z"));
            taf.TAFLine.Count().Should().Be(6);
            var tafLine = taf.TAFLine[0];
            tafLine.Altimeter_Hg.Should().BeNull();
            tafLine.ForecastTimeEnd.Should().Be(DateTime.Parse("2019-10-27T08:00:00Z"));
            tafLine.ForecastTimeStart.Should().Be(DateTime.Parse("2019-10-27T00:00:00Z"));
            ...
            tafLine.Altimeter_Hg.Should().BeNull();
            tafLine.ForecastTimeEnd.Should().Be(DateTime.Parse("2019-10-27T13:00:00Z"));
            tafLine.ForecastTimeStart.Should().Be(DateTime.Parse("2019-10-27T10:00:00Z"));
            tafLine.IcingHazards.Count.Should().Be(0);
            tafLine.NotDecoded.Should().BeNull();
            tafLine.Probability.Should().BeNull();
